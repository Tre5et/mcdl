...
public class FabricLoader {
    ...
    public static void downloadFabricClient(File outFile, FabricLoaderData loader) throws FileDownloadException {
        ...
        MavenPom mavenPom;
        try {
            mavenPom = FileUtil.parseMavenUrl(getFabricMavenUrl(), loader.getMaven());
        ...
        URL downloadUrl;
        try {
            downloadUrl = new URL(getFabricMavenUrl() + mavenUrl);
    ...
    public static FabricProfile getFabricProfile(String mcVersion, String fabricVersion) throws FileDownloadException {
        try {
            return FabricProfile.fromJson(FileUtil.getStringFromUrl(getFabricProfileUrl(mcVersion, fabricVersion)));
    ...
    public static FabricVersionDetails getFabricVersionDetails(String mcVersion, String fabricVersion) throws FileDownloadException {
        try {
            return FabricVersionDetails.fromJson(FileUtil.getStringFromUrl(getFabricVersionUrl(mcVersion, fabricVersion)));
        } catch (SerializationException e) {
    ...
    public static List<FabricVersionDetails> getFabricVersions(String mcVersion) throws FileDownloadException {
        ...
        try {
            List<FabricVersionDetails> v = FabricVersionDetails.fromJsonArray(FileUtil.getStringFromUrl(getFabricIndexUrl(mcVersion)));
            if(cacheVersions) {
