...
public class TestJava {
    ...
    public void testJavaVersion(String id) {
        ...
        JavaRuntimes runtimes = assertDoesNotThrow(MinecraftJava::getJavaRuntimes);
        ...
        for(JavaRuntimeRelease version : versions) {
            ...
            List<JavaFile> files = assertDoesNotThrow(() -> MinecraftJava.getJavaFiles(version.getManifest().getUrl()));
            ...
            assertDoesNotThrow(() -> MinecraftJava.downloadJavaFiles(dir, files));
